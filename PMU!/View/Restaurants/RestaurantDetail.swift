        ...
        VStack{
            ...
            ZStack(alignment: .topLeading ){
                ...
                VStack(alignment: .leading){
                    Text((restaurant?.result.name )) .font(.custom("Sukhumvit Set", size: 24 )).bold().foregroundColor(Color(red: 0, green: 0.133, blue: 0.251)).multilineTextAlignment(/*@START_MENU_TOKEN@*/.leading/*@END_MENU_TOKEN@*/).frame(width: 240, alignment: .leading)
